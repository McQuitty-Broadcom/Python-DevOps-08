...
- Your login: is mfwsuser8@demo.broadcom.com
...
- Your userid is CUST008.
- Your password CUST008.
...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate DOGGOS08 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate DOGGOS08 --type LNK --os --maxrc 0 --sn 1 --cb`
...
- To execute the application and see the output, we can call `zowe jobs`.
  - `zowe jobs submit dataset CUST008.PUBLIC.JCL(NDRUNDOG) --vasc`
...
`zowe jobs submit data-set "CUST008.MARBLES.JCL(MARBCOPY)" --vasc`
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-08.git`
